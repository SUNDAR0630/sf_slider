...
import CircularMultipleSlider from './Screens/CircularMultipleSlider';



const DIVIDER_COMPONENT_SIZE = 30;
const PERCENTAGE_TEXT = '%';


const REACT_IMAGE = require ('./Screens/resource/react.png');
const ANGULAR_IMAGE = require ('./Screens/resource/angular.png');
const SWIFT_IMAGE = require ('./Screens/resource/swift.png');
const ANDROID_IMAGE = require ('./Screens/resource/android.png');
const DIVIDER_IMAGE = require ('./Screens/resource/divider_icon.png');
  ...
  renderSliderWithCircleDivider() {
    return (
      <View style={{ height: 500, width: '100%' }}>
        <Text style={styles.title}>{'Loan Tracker  \nwith \nSF Divider'}</Text>
